...
Never skill node.exe -- claude code is a node app.
---

# Essential Context for {{Project}}
**Purpose**: Critical architectural patterns and conventions that aren't obvious from code alone. Read this before working on any feature.
