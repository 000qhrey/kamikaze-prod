...
/**
 * Saved for later — not mounted.
 * Previous EventCard expand + city-decrypt ritual (OVERRIDE).
 * Replaced by OverrideCrtModal channel-surf flow.
 */
...
interface EventCardExpandLegacyProps {
  event: Event
  index: number
}

/** @deprecated Not mounted — see OverrideCrtModal */
export function EventCardExpandLegacy({ event, index }: EventCardExpandLegacyProps) {
